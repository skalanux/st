...
static char font[] = "Source Code Pro for Powerline,Source Code Pro Medium:size=13";
//static char font[] = "Source Code Pro for Powerline Medium:pixelsize=12:antialias=false:autohint=false";
